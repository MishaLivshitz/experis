/*
 * This module implements a thread safe msg queue using queue, shared memory and sync mechanism
 * 
 ...
 * 			_memSize: memory size
 * 			_numOfItems: Max number of items in the queue
 * 
