...
template<fine typename A,fine typename B>inline bool mt_cxx_equal(const A& a, const B& b){return a == reinterpret_cast<A>(b);}inline bool mt_cxx_equal(const char* a, const char* b){return strcmp(a,b) == 0;}cl\
...
#\
de\
fine mt__ASSERT_STR(a,op,e,n) mt__STATEMENTS({const char*_a=(const char*)(a);const char*_e=(const char*)(e);mt__ASSERT(strcmp(_a,_e) op 0,__LINE__,n "(" #a ", " #e ")",mt__EXPECTED_s(_a,_e,\
#e,#a));}) 
\
#\
de\
